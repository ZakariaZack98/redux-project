...
const Summery = () => {
  const {firstName, lastName, gender, phone, email, address, zipCode} = useSelector(state => state.form);
  return (
    <div>
      <h1 className="text-2xl font-medium text-center text-blue-500">Summery:</h1>
      <div className="flex flex-col gap-y-2">
        <p className='text-blue-500 font-medium'>Full Name: <span className='text-black'>{firstName} {lastName}</span></p>
